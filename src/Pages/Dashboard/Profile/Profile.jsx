    ...
    <Row>
      <Col md="4">
        <Card className="card-user m-2 w-100 shadow">   
          <CardBody>
            <div style={{ backgroundColor: " #84B464",color:"white" }} className="author text-center rounded ">
              <a className="text-decoration-none" href="#pablo" onClick={(e) => e.preventDefault()}>
...
style={{ backgroundColor: " #84B464" }}                    type="submit"
                  >
                    Update Profile
                  </Button>
                </div>
